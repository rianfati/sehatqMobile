...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/registerNamaLengkapField'), 'Budi Irwan')
Mobile.sendKeys(findTestObject('Object Repository/registerJenisKelaminField'), 'Laki-laki')
Mobile.sendKeys(findTestObject('Object Repository/registerEmailField'), '')
Mobile.sendKeys(findTestObject('Object Repository/registerPasswordField'), 'Qwerty123')
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/registerEmailEmptyAlert'), 2)