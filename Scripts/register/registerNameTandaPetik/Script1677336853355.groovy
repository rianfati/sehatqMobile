...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/registerNamaLengkapField'), "Rifa'i Irwan")
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/registerOTPVerification'), 2)