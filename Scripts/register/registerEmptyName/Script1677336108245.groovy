...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/registerNamaLengkapField'), '')
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/registerNameEmptyAlert'), 2)