...
Mobile.sendKeys(findTestObject('Object Repository/registerPasswordField'), '')
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/registerPasswordEmptyAlert'), 2)