...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfileName'), '')
Mobile.delay(2)
...
Mobile.delay(2)
Mobile.swipe(526, 425, 504, 1976)
Mobile.delay(2)
Mobile.verifyElementExist(findTestObject('Object Repository/editProfileNameEmptyAlert'), 2)
