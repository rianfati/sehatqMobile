...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfileHeight'), 'xxx')
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfileWeight'), 'xxx')
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfilePhoneField'), 'xxx')
Mobile.delay(2)
