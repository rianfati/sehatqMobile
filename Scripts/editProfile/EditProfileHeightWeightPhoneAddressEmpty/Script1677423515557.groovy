...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfileHeight'), '')
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfileWeight'), '')
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/editProfilePhoneField'), '')
Mobile.delay(2)
...
Mobile.verifyElementNotExist(findTestObject('Object Repository/editProfileSuccesAlert'), 2)
Mobile.swipe(484, 1722, 491, 621)
Mobile.delay(3)
Mobile.sendKeys(findTestObject('Object Repository/editProfileAddress'), '')
Mobile.delay(2)
Mobile.tap(findTestObject('Object Repository/editProfileSaveButton'), 1)
Mobile.verifyElementNotExist(findTestObject('Object Repository/editProfileSuccesAlert'), 2)
