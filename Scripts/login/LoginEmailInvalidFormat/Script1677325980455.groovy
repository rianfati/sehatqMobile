...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/loginFieldEmail'), 'rianfatigmailcom')
Mobile.delay(2)
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/loginAlertEmailInvalidFormat'), 5)
