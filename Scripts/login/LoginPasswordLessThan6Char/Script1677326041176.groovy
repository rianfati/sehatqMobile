...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/loginFieldPassword'), 'Qwer')
Mobile.delay(5)
Mobile.tap(findTestObject('Object Repository/loginSubmitButton2'), 1)
Mobile.delay(2)
Mobile.verifyElementExist(findTestObject('Object Repository/loginAlertPasswordLessThan6Char'), 5)
