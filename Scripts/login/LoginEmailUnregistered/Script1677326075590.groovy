...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/loginFieldEmail'), 'budiwak@mail.com')
Mobile.delay(2)
...
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/loginAlertEmailUnregistered'), 5)
