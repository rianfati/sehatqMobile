...
Mobile.delay(2)
Mobile.sendKeys(findTestObject('Object Repository/loginFieldPassword'), '')
Mobile.delay(5)
Mobile.tap(findTestObject('Object Repository/loginSubmitButton2'), 1)
Mobile.delay(5)
Mobile.verifyElementExist(findTestObject('Object Repository/loginAlertPasswordEmpty'), 5)
